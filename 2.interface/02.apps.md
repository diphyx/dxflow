...
::card-group
  ...
  **Complex Workflows** - End-to-end pipeline orchestration
  ...
  ::card{title="Real-time Monitoring" icon="i-hugeicons:activity"}
...
::tabs
  ...
  **Real-time Status Monitoring**
  ...
  ::tab-item{label="Quick Actions" icon="i-hugeicons:cursor-click"}
...
::card-group
  ::card{title="Visual Pipeline Builder" icon="i-hugeicons:hierarchy-square-01"}
  **Drag-and-Drop Creation**
  ...
  ::card{title="Pipeline Templates" icon="i-hugeicons:template"}
  **Pre-built Workflows**
  ...
  ::card{title="Advanced Logic" icon="i-hugeicons:logic-circuit"}
  **Smart Orchestration**
...
::tabs
  ...
  **Centralized Logging**
  ...
  ::tab-item{label="Alerting" icon="i-hugeicons:alarm"}
...
::tabs
  ...
  **Application Operations**
  ...
  ::tab-item{label="Monitoring" icon="i-hugeicons:activity"}
